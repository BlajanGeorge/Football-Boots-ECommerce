...
export const AdminConsoleBoots = () => {
    ...
    async function createBoots(){
      const res = await axios.post('http://localhost:10000/boots', {name, description, brand, photoPath, bigPhotoPath, footballBootsAttributesCreateRequestList : [ {size : 35, price : priceForSize35, quantity : quantityForSize35}, 
